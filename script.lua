if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("Infinite Yield Explain Edition is already running!", 0)
    return
end
...
if not game:IsLoaded() then
    ...
    notLoaded.Text = "Infinite Yield Explain Edition is waiting for the game to load"
    game.Loaded:Wait()
    notLoaded:Destroy()
end

currentVersion = "5.34176461.7"
...
Title.TextSize = 18
Title.Text = "Infinite Yield Explain Edition FE v" .. currentVersion
